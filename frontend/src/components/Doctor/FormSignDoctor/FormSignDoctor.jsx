...
export default function FormSignDoctor() {
    ...
    async function handleSign(e) {
        e.preventDefault();
        const resp = await fetch("/api/signDoctor", {
            method: "POST",
        ...
        <div class="container-form">
            ...
            <form onSubmit={handleSign} id="form" class="form">
                <div class="form-content">
                    ...
                    <input type="text" value={doctorName} onChange={(e) => setDoctorName(e.target.value)} placeholder="Digite seu nome:" required />
                </div>
                <div class="form-content">
                    <label for="doctorPassword">Senha:</label>
                    <input type="password" value={doctorPassword} onChange={(e) => setDoctorPassword(e.target.value)} placeholder="Digite a sua senha:" required />
                </div>
                <p>Já possui uma conta? <a href="/loginDoctor">Login</a></p>
